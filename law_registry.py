...
SEED_ALIAS_RULES: list[dict[str, Any]] = [
    ...
    # --- عقوبات / جزاء ---
    {
        "aliases": ["قانون العقوبات", "العقوبات", "قانون الجزاء"],
    ...
    {
        "aliases": ["الاحوال المدنية", "الأحوال المدنية", "سجل مدني"],
        "title_any": ["الاحوال المدنية", "الأحوال المدنية"],
    },
    {
        "aliases": ["رعاية القاصرين", "قانون رعاية القاصرين"],
        "title_any": ["رعاية القاصرين"],
    },
    # --- عمل / ضمان ---
    {
        "aliases": ["قانون العمل", "قانون العمل العراقي"],
        "title_any": ["قانون العمل رقم", "قانون العمل"],
    },
    {
        "aliases": [
            "الضمان الاجتماعي",
        ...
        "title_any": ["الضمان الاجتماعي", "التقاعد والضمان الاجتماعي"],
    },
    {
        "aliases": ["قانون التقاعد", "التقاعد الموحد", "تقاعد الموظفين"],
        "title_any": ["التقاعد", "تقاعد"],
    },
    # --- مدني / إيجار / عقاري ---
    {
        "aliases": ["القانون المدني", "قانون مدني", "المدني العراقي"],
        "title_any": [
            "القانون المدني رقم ٤٠",
            "القانون المدني رقم 40",
            "القانون المدني رقم٤٠",
        ],
    },
    {
        "aliases": [
        ...
        "title_any": ["ايجار العقار", "إيجار العقار"],
    },
    {
        "aliases": ["التسجيل العقاري", "قانون التسجيل العقاري", "الطابو"],
        "title_any": ["التسجيل العقاري"],
    },
    {
        "aliases": ["الاستملاك", "قانون الاستملاك"],
        "title_any": ["الاستملاك"],
    },
    # --- شركات / تجارة ---
    {
    ...
    },
    {
        ...
        "title_any": ["قانون التجارة"],
    },
    {
        "aliases": ["افلاس", "الإفلاس", "قانون الافلاس"],
        "title_any": ["الافلاس", "الإفلاس", "التجارة"],
    },
    # --- مرافعات / إثبات / تنفيذ / عدل ---
    {
        "aliases": [
            "المرافعات المدنية",
            "قانون المرافعات",
        ...
        "title_any": ["المرافعات المدنية"],
    },
    {
        "aliases": ["قانون الاثبات", "قانون الإثبات", "الاثبات"],
        "title_any": ["الاثبات", "الإثبات"],
    },
    {
        "aliases": ["قانون التنفيذ", "دائرة التنفيذ", "التنفيذ العدلي"],
        "title_any": ["قانون التنفيذ", "التنفيذ"],
    },
    {
        "aliases": [
            "كاتب العدل",
        ...
        "title_any": ["الكتاب العدول", "كاتب العدل"],
    },
    {
        "aliases": ["التنظيم القضائي", "قانون التنظيم القضائي"],
        "title_any": ["التنظيم القضائي"],
    },
    {
        "aliases": ["قانون المحاماة", "نقابة المحامين"],
        "title_any": ["المحاماة"],
    },
    # --- خدمة مدنية / موظفين ---
    {
        ...
        "title_any": [
            "الخدمة المدنية رقم ٢٤",
            "الخدمة المدنية رقم 24",
            "الخدمة المدنية",
        ],
    },
    {
        "aliases": ["انضباط موظفي الدولة", "قانون انضباط"],
        "title_any": ["انضباط موظفي الدولة", "انضباط موظفي"],
    },
    # --- ضريبة / جمارك / مالية ---
    {
        "aliases": ["ضريبة الدخل", "قانون ضريبة الدخل"],
        "title_any": ["ضريبة الدخل"],
    },
    {
        "aliases": ["قانون الجمارك", "الجمارك"],
        "title_any": ["الجمارك"],
    },
    {
        "aliases": ["الضريبة العقارية", "قانون الضريبة العقارية"],
        "title_any": ["الضريبة العقارية"],
    },
    {
        "aliases": ["الموازنة الاتحادية", "قانون الموازنة"],
        "title_any": ["الموازنة"],
    },
    # --- نفط / استثمار / بلديات ---
    {
        "aliases": ["قانون النفط", "النفط والغاز", "الثروة النفطية"],
        "title_any": ["النفط", "الغاز"],
    },
    {
        "aliases": ["قانون الاستثمار", "هيئة الاستثمار", "الاستثمار العراقي"],
        "title_any": ["الاستثمار"],
    },
    {
        "aliases": [
            ...
            "ادارة البلديات",
            "إدارة البلديات",
            "قانون إدارة البلديات",
        ],
        "title_any": ["البلديات", "ادارة البلديات", "إدارة البلديات"],
    },
    # --- جنسية / مرور / مستهلك / مصارف ---
    {
        "aliases": ["قانون الجنسية", "الجنسية العراقية"],
        "title_any": ["الجنسية"],
    },
    {
        "aliases": ["قانون المرور", "مرور"],
        "title_any": ["المرور"],
    },
    {
        "aliases": ["حماية المستهلك", "قانون حماية المستهلك"],
        "title_any": ["حماية المستهلك"],
    },
    {
        "aliases": ["البنك المركزي", "قانون المصارف", "قانون البنوك"],
        "title_any": ["البنك المركزي", "المصارف"],
    },
    {
        "aliases": ["غسل الاموال", "غسل الأموال", "مكافحة غسل الاموال"],
        "title_any": ["غسل الاموال", "غسل الأموال"],
    },
    # --- جمعيات / أحزاب / انتخابات / دستور ---
    {
        "aliases": ["قانون الجمعيات", "الجمعيات"],
        "title_any": ["الجمعيات"],
    },
    {
        "aliases": ["الاحزاب السياسية", "الأحزاب السياسية", "قانون الاحزاب"],
        "title_any": ["الاحزاب", "الأحزاب"],
    },
    {
        "aliases": ["قانون الانتخابات", "الانتخابات"],
        "title_any": ["الانتخابات", "الانتخاب"],
    },
    {
        "aliases": ["دستور العراق", "الدستور العراقي"],
        "title_any": ["دستور جمهورية العراق", "دستور العراق"],
    },
    # --- صحة / تعليم عام / بيئة ---
    {
        "aliases": ["قانون الصحة العامة", "الصحة العامة"],
        "title_any": ["الصحة العامة"],
    },
    {
        "aliases": ["قانون وزارة التربية", "التربية والتعليم"],
        "title_any": ["وزارة التربية", "التربية"],
    },
    {
        "aliases": ["حماية البيئة", "قانون حماية البيئة"],
        "title_any": ["حماية البيئة", "البيئة"],
    },
    # --- أمن / أسلحة / إرهاب ---
    {
        "aliases": ["مكافحة الارهاب", "مكافحة الإرهاب", "قانون الارهاب"],
        "title_any": ["الارهاب", "الإرهاب"],
    },
    {
        "aliases": ["حمل الاسلحة", "حمل الأسلحة", "قانون الاسلحة"],
        "title_any": ["الاسلحة", "الأسلحة"],
    },
]
    ...
    *,
    ...
    if use_law_cards():
        try:
            ...
            if cards:
                rows = [
                    merge_card_aliases_into_registry_row(
                        r, cards.get(int(r["law_book_id"]))
                    )
                    for r in rows
                ]
        except Exception:
